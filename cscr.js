...
{		
	...
	let topLinks = '&nbsp;&nbsp;<span id="back-to-original">Назад к оригинальному ЛКС</span>&nbsp;|&nbsp;<span id="open_lk">Открыть ЛК</span>&nbsp;|&nbsp;<span id="pay_history">История операций</span>&nbsp;|&nbsp;<span id="sup_link">Клиент в СУП</span> !!!  cloud test'+updMsg;	
